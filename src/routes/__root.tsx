...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Vansh — Outbound for B2B SaaS" },
      { name: "description", content: "Cold email, meeting setting, and pipeline generation for Indian B2B SaaS." },
      { name: "author", content: "Vansh" },
