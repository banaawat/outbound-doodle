...
export const RESOURCES: Resource[] = [
  ...
  {
    slug: "outbound-for-plg-playbook",
    cat: "Playbooks",
    title: "Outbound for PLG companies — the 6-week playbook",
    desc: "You have a free tier. Most prospects can self-serve. That makes outbound harder — your job is to accelerate the ones the product won't convert on its own. Signal stack, week-by-week tasks, and the CTA that doesn't compete with 'just try it'.",
    cta: "Read playbook",
    meta: "11 min read",
    tag: "New",
    reads: "2.1k reads",
    whatsInside: [
      "Why PLG outbound is harder than classic outbound",
      "Signal stack — free-tier usage, job posts, funding, team growth",
      "Week-by-week task list — signal → sequence → convert",
      "The CTA that doesn't compete with self-serve",
      "Copy templates for free-to-paid conversion",
    ],
    body: [
      { type: "h2", text: "Why PLG outbound is different" },
      { type: "p", text: "In classic outbound, urgency comes from scarcity. In PLG outbound, your prospect can always say 'I'll just try it free' and kill your pipeline with courtesy. The job isn't to create urgency — it's to show the gap between what they're getting on the free tier and what they'd get with your help." },
      { type: "h2", text: "The signal stack" },
      { type: "list", items: [
        "Free-tier signups from target-domain companies — your product data has this already.",
        "Usage hitting a ceiling — seat limit, export cap, API call volume. Find it in analytics.",
        "Job posts for roles that signal scale pressure (Head of RevOps, SDR Manager, Senior Data Analyst).",
        "LinkedIn activity from free-tier users — job change, funding announcement, team growth post.",
      ] },
      { type: "h2", text: "The 6-week breakdown" },
      { type: "list", items: [
        "Week 1–2: pull free-tier signups from T1 ICP domains, score by headcount growth and usage depth, cap at 50 accounts.",
        "Week 3 (touch 1, day 1): name the signal + the gap + soft ask — under 60 words, no calendar link.",
        "Week 3 (touch 2, day 5): value drop — peer benchmark, teardown, or 1-line case study. Never a bump.",
        "Week 4 (touch 3, day 10): breakup or upgrade prompt — 'free tier working? No action needed. If not, let's talk.'",
        "Week 5–6: audit who converted, find the pattern (usage depth + signal type), run the next cohort of 50.",
      ] },
    ],
  },
  {
    slug: "post-campaign-audit-checklist",
    cat: "Checklists",
    title: "Post-campaign audit checklist (18 points)",
    desc: "18 checks to run within 48 hours of closing any sequence — reply rate analysis, domain health, copy failure diagnosis, and what to fix before the next campaign.",
    cta: "Get checklist",
    meta: "PDF · 2 pages",
    tag: "New",
    reads: "1.1k downloads",
    whatsInside: [
      "18 post-send checks (one tickbox each)",
      "Reply classification system (positive / neutral / OOO / negative)",
      "Domain health read — Google Postmaster + blacklist checks",
      "Copy failure diagnosis — where the open, reply, or CTA dropped",
    ],
    body: [
      { type: "h2", text: "The non-negotiables" },
      { type: "list", items: [
        "Bounce rate logged — above 5% is a domain-health problem, not a list problem.",
        "Reply rate benchmarked against your last sequence on the same ICP, not industry averages.",
        "Every positive reply tagged by which touch it came from — touch 1 vs breakup matters.",
        "Every negative reply reviewed for objection pattern — not just deleted.",
        "Out-of-office contacts re-queued 7 days out with a fresh send window.",
        "High open + low reply flagged as CTA or body failure — not 'bad list'.",
        "All sending domains checked on MXToolbox for new blacklist entries.",
        "Google Postmaster spam rate confirmed below 0.1%.",
        "Meetings booked traced to exact email and touch number.",
        "No-show rate logged — above 40% means ICP or pitch is off.",
      ] },
      { type: "p", text: "Run this within 48 hours — wait a week and you lose the context that makes it useful. The audit is where the next campaign's reply rate gets built." },
    ],
  },
];
